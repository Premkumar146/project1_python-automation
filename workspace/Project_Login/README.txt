This is a Project Folder for "Project Login"

Login: To login to the OrangeHRM portal.
...
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Login\reports\test_prem testprem.py