This is a Project Folder for "Project Pimadd"

PIMAdd: To add a new user to the employee list.
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Pimadd\reports\test_prem.html testprem.py