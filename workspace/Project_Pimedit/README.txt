This is a Project Folder for "Project Pimedit"

PIMAdd: To edit a  employee list.
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Pimedit\reports\test_prem.html testprem.py