...
class Test_Prem:
    ...
    def test_pimedit(self, booting_function):
        self.driver.get(self.url)
        time.sleep(5)
        ...
        time.sleep(3)
        self.driver.find_element(by=By.XPATH, value=data.Prem_Selectors.employeelist_xpath).click()
        time.sleep(5)
        self.driver.find_element(by=By.XPATH, value=data.Prem_Selectors.employeename_xpath).send_keys('prem')
        time.sleep(5)
        self.driver.find_element(by=By.XPATH, value=data.Prem_Selectors.search_xpath).click()
        time.sleep(5)
        self.driver.find_element(by=By.XPATH, value=data.Prem_Selectors.delete_xpath).click()
        time.sleep(5)
        self.driver.find_element(by=By.XPATH, value=data.Prem_Selectors.yesbutton_xpath).click()
        time.sleep(5)

        print('DELET EMPLOYEE SUCCESSFULLY')
