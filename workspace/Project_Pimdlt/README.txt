This is a Project Folder for "Project Pimdlt"

PIMAdd: To deletuser to the employee list.
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Pimdlt\reports\test_prem.html testprem.py